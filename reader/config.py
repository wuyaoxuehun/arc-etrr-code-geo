...
parser.add_argument('--print_every', type=int, default=20, help='period to print loss during training')
parser.add_argument('--seed', type=int, default=1234, help='random seed')
parser.add_argument('--shuffle_seed', type=int, default=1234, help='randoms shuffle data seed')
...
parser.add_argument('--reform', type='bool', default=True, help='Whether reformulate query using essential terms')

parser.add_argument('--test_recent_k', type=int, default=1, help='test with recent k models')
