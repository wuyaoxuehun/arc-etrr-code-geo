...
parser.add_argument('--epoch', type=int, default=200, help='Number of epoches to run')
...
parser.add_argument('--lr', type=float, default=5e-3, help='learning rate') # 2e-3
parser.add_argument('--weight_decay', type=float, default=0, help='weight decay') 
parser.add_argument('--pos_weight', type=float, default=2.5, help='positive weight for imbalanced dataset') 
parser.add_argument('--batch_size', type=int, default=256, help='batch size')
parser.add_argument('--embedding_file', type=str, default='./data/embeddings/sgns.wiki.word', help='embedding file')
...
parser.add_argument('--dropout_rnn_output', type=float, default=0.5, help='dropout for RNN output')
parser.add_argument('--rnn_padding', type='bool', default=True, help='Use padding or not')
parser.add_argument('--dropout_emb', type=float, default=0.5, help='dropout rate for embeddings')
parser.add_argument('--pretrained', type=str, default='', help='pretrained model path')
parser.add_argument('--pretrain_dataset', type=str, default='', help='pretrain dataset name')
...
parser.add_argument('--use_elmo', type='bool', default=False, help='use elmo or not')
parser.add_argument('--elmo_num_layer', type=int, default=1, help='Number of elmo layers will be used for training')
parser.add_argument('--use_science_term', type='bool', default=True, help='use science term as feature or not')
parser.add_argument('--dataset', type=str, default='Challenge', help='dataset name')
